    ...
    <main>
        ...
        $pageRoutes = [
            ...
            'es-419' => [
                ...
                'HW CPU' => 'hw_cpu',
                'HW RAM' => 'hw_ram',
                'HW Placa Base' => 'hw_motherboard',
                'HW Carcasa' => 'hw_chassis',
                'HW Almacenamiento' => 'hw_storage',
                'HW Fuente de Poder' => 'hw_psu',
                'HW Tarjeta Grafica' => 'hw_gpu',
                'HW Enfriamiento' => 'hw_coolers',
                'HW Dispositivos de Entrada' => 'hw_input_devices',
                'HW Dispositivos de Salida' => 'hw_output_devices',
                'HW Perifericos' => 'hw_peripherals_and_gear',
                'HW Ratón' => 'hw_mouse',
                'HW Teclado' => 'hw_keyboard',
                'HW Monitor' => 'hw_monitor',
                'HW Tarjetas PCI' => 'hw_pci_cards',
                'HW Memoria Portatil' => 'hw_portableMemory',
                'HW Escáneres' => 'hw_scanners',
                'HW Impresoras' => 'hw_printers',
                'HW Controladores de Consola' => 'hw_console_controllers',
                'HW Joysticks' => 'hw_joysticks',
                'HW Tablets' => 'hw_tablets',
                'HW Micrófonos' => 'hw_microphones',
                'HW Headsets' => 'hw_headsets',
                'HW Audífonos' => 'hw_headphones',
                'HW Mezcladoras de Audio' => 'hw_audio_mixers',
                'HW Controladores' => 'hw_controllers',
                'HW Uniformes de Gaming' => 'hw_gaming_uniforms',
                'HW Lápices, Plumas y Tablets' => 'hw_pens_pencils_tablets',
                'HW Sillas' => 'hw_chairs',
                'HW Escritorios' => 'hw_desks',
                'HW Tapetes Antideslizantes' => 'hw_anti_slip_mats',
                'HW Altavoces y Subwoofers' => 'hw_speakers_and_subwoofers',
            ]
        ];
