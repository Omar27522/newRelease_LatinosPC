...
@keyframes float {
    ...
    100% {
        transform: translateX(-31px) translateY(-31px);
    }
}
...
<section id="^" class="section fullbar">
    ...
    <h3><span class="emoji">🏔️</span>The Big Talk About the End Times</h3>
    ...
    <section id="^" class="section fullbar">
        ...
        <h3><span class="emoji">⛰️</span>Lesson 1: The Sermon on the Mount (How to Live a Good Life)</h3>
        ...
        <p>
            Teachings on Worry and Judgment (Matthew 6:25-7:6) address practical concerns of
            daily life while maintaining focus on spiritual priorities. Jesus's teaching about not
        ...
        <h3><span class="emoji">🔔</span>The Second Discourse: The Mission Discourse (Matthew 10)</h3>
        <div class="highlight-box">
        ...
        <div class="story-box">
            <h4>The Third Discourse: The Parabolic Discourse (Matthew 13)</h4>
        ...
        <div class="story-box">
            <h4>The Fourth Discourse: The Discourse on the Church (Matthew 18)</h4>
        ...
        <div class="story-box">
            <h4>The Fifth Discourse: The Olivet Discourse (Matthew 23-25)</h4>
    ...
    ?>
        ...
        <section id="^" class="section fullbar">
            ...
            <p class="story-box">The Witness of John the Baptist (John 1:6-8, 15) establishes the relationship between
            ...
            <p class="story-box">The Incarnation and Revelation (John 1:9-14, 16-18) describes the Word's entrance
            ...
            <p class="story-box">The Prologue concludes with the declaration that "No one has seen God at any time. The
            ...
            <p class="story-box">Jesus's conversation with Nicodemus represents the first major discourse in John's
            ...
            <p class="story-box">The Heavenly Witness (John 3:9-15) addresses Nicodemus's confusion about spiritual
                ...
                and salvation.</p>
            <p class="story-box">God's Love and Judgment (John 3:16-21) contains what is perhaps the most famous
            ...
            <p class="story-box">This discourse establishes several key themes that will recur throughout John's Gospel:
            ...
            <p class="story-box">The Discourse with the Samaritan Woman: Living Water (John 4:1-42)
            ...
            <p class="story-box"></p>The Request for Water (John 4:1-15) begins with Jesus's simple request for a drink,
            which surprises the Samaritan woman because of the hostility between Jews and
            Samaritans. Jesus redirects the conversation by offering "living water" that becomes "a
            fountain of water springing up into everlasting life" (John 4:14). This metaphor of living
            water builds on Old Testament imagery of God as the source of living water (Jeremiah
            2:13, 17:13) while pointing to the spiritual satisfaction that comes through relationship
            with Christ.</p>
            <p class="story-box"></p>True Worship (John 4:16-24) shifts to a discussion of worship after Jesus
            demonstrates
            supernatural knowledge of the woman's marital history. When she raises the question of
            the proper location for worship—Mount Gerizim for Samaritans or Jerusalem for Jews—
            Jesus transcends the geographical dispute by declaring that "the hour is coming, and
            now is, when the true worshipers will worship the Father in spirit and truth" (John 4:23).
            This teaching establishes that authentic worship depends not on location but on the
            worshiper's spiritual condition and relationship with God.</p>
            <p class="story-box"></p>The Messiah's Self-Revelation (John 4:25-26) represents one of the clearest
            declarations of Jesus's messianic identity in the Gospels. When the woman mentions the
            coming Messiah who "will tell us all things," Jesus responds with the direct statement, "I
            who speak to you am He" (John 4:26). This explicit self-identification as the Messiah
            contrasts with the more guarded approach found in the Synoptic Gospels, where Jesus
            often discourages public declarations of his messianic status.</p>
            <p class="story-box">The Harvest of Souls (John 4:27-42) extends the discourse to include Jesus's
                conversation with his disciples about spiritual harvest and the subsequent belief of
                many Samaritans. Jesus's statement that "the fields... are already white for
                harvest" (John 4:35) establishes the urgency of the evangelistic mission while his
                discussion of sowers and reapers acknowledges the cooperative nature of spiritual
                ministry. The Samaritans' confession that Jesus is "the Savior of the world" (John 4:42)
                emphasizes the universal scope of his mission beyond the boundaries of Judaism.
                This discourse demonstrates Jesus's concern for those marginalized by religious and
                social structures while establishing principles for authentic worship that transcend
                cultural and geographical limitations. The woman's transformation from skeptic to
                evangelist illustrates the life-changing impact of encountering Jesus and recognizing his
                true identity.</p>
            <h3><span class="emoji">🏃</span>The Discourse at Bethesda: Divine Authority (John 5)</h3>
            <p class="story-box">Following the healing of a paralyzed man at the pool of Bethesda on the Sabbath, Jesus
                ...
                Gospels.</p>
            <p>
            <h3 class="story-box">The Sabbath Controversy</h3>The Sabbath Controversy (John 5:1-18) begins with Jesus
            healing a man who had
            been paralyzed for thirty-eight years. When the Jewish leaders object to the man
            carrying his mat on the Sabbath and later to Jesus healing on the Sabbath, Jesus
            responds with the statement, "My Father has been working until now, and I have been
            working" (John 5:17). This claim to a unique relationship with God as Father and to
            divine prerogative regarding the Sabbath provokes charges of blasphemy and intensifies
            the conflict with religious authorities.</p>
            <p class="story-box"></p>The Son's Relationship with the Father (John 5:19-23) establishes the intimate
            ...
            <p class="story-box"></p>Life and Judgment (John 5:24-30) addresses Jesus's authority to give life and
            execute
            ...
            <p class="story-box"></p>Witnesses to Jesus (John 5:31-47) addresses the question of evidence for Jesus's
            ...
            <p class="story-box"></p>Following the feeding of the five thousand, Jesus delivers the Bread of Life
            discourse,
            ...
            <p class="story-box"></p>The Search for Jesus (John 6:22-24) describes the crowds following Jesus to
            ...
            <p class="story-box"></p>The Work of God (John 6:25-29) begins with Jesus challenging the crowds'
            motivation,
            ...
            <p class="story-box"></p>The True Bread from Heaven (John 6:30-40) responds to the crowds' request for a
            sign
            comparable to the manna given through Moses. Jesus clarifies that it was not Moses but
            God who gave the manna and that God "gives you the true bread from heaven" (John
            6:32). His declaration "I am the bread of life" (John 6:35) represents the first of seven "I
            am" statements in John's Gospel, each of which reveals an aspect of Jesus's identity and
            mission. The promise that "everyone who sees the Son and believes in Him may have
            everlasting life" (John 6:40) establishes faith in Christ as the path to eternal life.
            Murmuring and Divine Drawing (John 6:41-51) addresses the Jews' objection to
            Jesus's claim to have "come down from heaven" given their knowledge of his human
            parentage. Jesus responds by emphasizing the necessity of divine drawing: "No one can
            come to Me unless the Father who sent Me draws him" (John 6:44). This teaching
            establishes the supernatural nature of faith and the essential role of divine initiative in
            salvation. Jesus's statement that "he who believes in Me has everlasting life" (John 6:47)
            reiterates the centrality of faith while his declaration that "the bread that I shall give is
            My flesh, which I shall give for the life of the world" (John 6:51) introduces the sacrificial
            aspect of his mission.</p>

            <p class="story-box"></p>Eating Flesh and Drinking Blood (John 6:52-59) presents Jesus's most controversial
            ...
            from his hearers. The repeated emphasis on eating his flesh and drinking his blood,
            coupled with the promise that "he who eats My flesh and drinks My blood abides in Me,
            and I in him" (John 6:56), establishes the necessity of intimate spiritual union with
            Christ. While Christians have interpreted this teaching in various ways—some seeing it as
            a reference to the Eucharist, others as a metaphor for faith—the emphasis on complete
            ...
            <p class="story-box">The Light of the World Discourse (John 8:12-30)
                Following the controversy over the woman caught in adultery, Jesus declares himself to
            ...
            <p class="highlight-box">The Declaration and Challenge (John 8:12-20) begins with Jesus's statement, "I am
            ...
            <p class="highlight-box">Origin and Destiny (John 8:21-24) addresses the question of Jesus's identity in
                terms
            ...
            <p class="highlight-box"></p>The Son's Relationship with the Father (John 8:25-30) responds to the direct
            question
            ...
            <p class="highlight-box"></p>This discourse establishes Jesus as the divine light who reveals truth and
            guides
            ...
            <h2><span class="emoji">🏃</span>The Good Shepherd Discourse (John 10:1-18)</h2>
            ...
            authorization. The description of the sheep recognizing the shepherd's voice and
            following him establishes the intimate relationship between Jesus and his followers and
            ...
            "steal, and kill, and destroy" and Jesus who came "that they may have life, and that they
            may have it more abundantly" (John 10:10) establishes the life-giving purpose of Jesus's
            ...
            love: "The good shepherd gives His life for the sheep" (John 10:11). The contrast
            between the good shepherd and the hireling who abandons the sheep in danger
            establishes the depth of Jesus's commitment to his followers. The statement that "I lay
            down My life for the sheep" (John 10:15) anticipates Jesus's sacrificial death while the
            declaration that "I have power to lay it down, and I have power to take it again" (John
            10:18) points to his resurrection and establishes his divine authority over life and death.
            This discourse establishes Jesus as both the exclusive means of salvation (the door) and
            the sacrificial protector of his people (the good shepherd). The emphasis on Jesus's
            ...
            extended teaching, delivered on the night of Jesus's betrayal, provides essential
            ...
            leads to Judas's departure, after which Jesus gives the new commandment: "Love one
            another; as I have loved you" (John 13:34). This establishes sacrificial love as the
            ...
            while the declaration "I am the way, the truth, and the life. No one comes to the Father
            except through Me" (John 14:6) establishes Jesus as the exclusive mediator between
            God and humanity. The teaching about Jesus's unity with the Father—"He who has seen
            Me has seen the Father" (John 14:9)—establishes Jesus as the definitive revelation of
            God while the promise of greater works through prayer in Jesus's name establishes the
            ...
            of truth" establishes the Holy Spirit's role in guiding believers into truth while the
            promise that "I will not leave you orphans; I will come to you" (John 14:18) suggests
            Jesus's continued presence through the Spirit. The teaching about the indwelling of the
            ...
            emphasis on abiding—"He who abides in Me, and I in him, bears much fruit; for without
            Me you can do nothing" (John 15:5)—establishes complete dependence on Christ as the
            essential condition for spiritual productivity. The restatement of the love commandment
            and the designation of the disciples as "friends" rather than servants establishes the
            intimate nature of their relationship with Jesus and the privilege of sharing in his
            mission.
            </p>
            ...
            conflict between Christ's followers and the world system. The promise of the Holy
            Spirit's coming to "convict the world of sin, and of righteousness, and of
            judgment" (John 16:8) establishes the Spirit's role in confronting unbelief while the
            promise to "guide you into all truth" (John 16:13) establishes the Spirit's role in
            illuminating believers. The assurance that the Spirit "will glorify Me" (John 16:14)
            establishes Christ-centeredness as the criterion for authentic spiritual ministry.
            Sorrow Turned to Joy (John 16:16-33) addresses the disciples' confusion and grief
            ...
            direct access to the Father "in My name" (John 16:23) establishes a new relationship with
            God based on Jesus's mediatorial work. The final assurance—"In the world you will have
            ...
            The High Priestly Prayer (John 17) concludes the Farewell Discourse with Jesus's
            extended prayer for himself, his disciples, and all future believers. The prayer for
            glorification—"Glorify Your Son, that Your Son also may glorify You" (John 17:1)—
            establishes the mutual glorification of Father and Son through the work of redemption.
            The definition of eternal life as knowing "the only true God, and Jesus Christ whom You
            have sent" (John 17:3) establishes salvation in relational rather than merely temporal
            terms. The prayer for the disciples' protection, sanctification, and unity establishes
            Jesus's ongoing concern for his followers and his vision for the church's witness in the
            world. The final prayer for all believers "that they may be one" and "that the love with
            which You loved Me may be in them" (John 17:26) establishes unity and love as the
            ultimate goals for the Christian community.
            </p>

            <p class="highlight-box">
            <h2><span class="emoji">🏃</span>The Farewell Discourse (John 13-17)</h2>
            The Farewell Discourse represents John's most comprehensive presentation of Jesus's
            ...
            challenges of living as Christ's representatives in a hostile world.
            </p>

            <p class="highlight-box">
            <h2><span class="emoji">🏃</span>John's Theological Contribution</h2>
            ...
            <p class="highlight-box">
            <h2><span class="emoji">🏃</span>John's Presentation of Jesus's Discourses</h2>
            John's presentation of Jesus's discourses thus provides essential theological content
            ...
            faith and the nature of relationship with God through Christ.
            </p>
            </section>
    ...
    ?>
            ...
            <section id="^" class="section fullbar">
                ...
                <p class="story-box">The Reading from Isaiah (Luke 4:16-19) describes Jesus entering the synagogue on
                    the
                    Sabbath, standing up to read, and being handed the scroll of Isaiah. His selection of
                    Isaiah 61:1-2 is highly significant, as this passage describes the mission of the Messiah in
                ...
                <p class="story-box">The Proclamation of Fulfillment (Luke 4:20-22) describes Jesus's dramatic statement
                    after reading the Isaiah passage: "Today this Scripture is fulfilled in your hearing" (Luke
                    4:21). This declaration represents Jesus's explicit claim to be the Messiah described in
                    Isaiah's prophecy and establishes his ministry as the fulfillment of Old Testament
                    promises. The initial positive response of the crowd, who "marveled at the gracious
                    words which proceeded out of His mouth," suggests the appealing nature of Jesus's
                    message before controversy erupted.</p>

                <p class="story-box">The Challenge to Expectations (Luke 4:23-27) records Jesus's anticipation of the
                    crowd's demand for miraculous signs like those performed in Capernaum. His reference
                    to the proverb "Physician, heal yourself" suggests their expectation that he would
                    demonstrate his powers in his hometown. Jesus's response cites two examples from the
                    Old Testament—Elijah's ministry to the widow of Zarephath and Elisha's healing of
                    Naaman the Syrian—both of which involve God's prophets ministering to Gentiles rather
                    than Israelites. These examples establish the precedent for Jesus's ministry extending
                    beyond national boundaries and anticipate the universal scope of the gospel that will be
                    a major theme in Luke-Acts.</p>

                <p class="story-box">The Violent Rejection (Luke 4:28-30) describes the crowd's furious response to
                    Jesus's
                    ...
                    Jesus "passing through the midst of them, went His way" suggests a supernatural
    ...
    <p>Mark was like the friend who's always in a hurry and gets straight to the point. Mark's Gospel is the shortest of the four, and it's packed with action! Instead of writing down lots of long speeches that Jesus gave, Mark focused on showing us what Jesus did.</p>

    <h3><span class="emoji">🏃‍♂️</span>Mark's Focus: What Jesus Did</h3>
    <p>While Matthew focused on what Jesus said, Mark focused on what Jesus did. Mark wanted to show people that Jesus wasn't just a good teacher - He was someone with amazing power who could do things that only God could do.</p>
    ...
    <ul style="margin-left: 20px;">
        ...
        <li>"Why are you so afraid? Do you still have no faith?" (This helped the disciples think about trusting God)</li>
    </ul>

    <div class="highlight-box">
        <p><strong>Following Jesus is Hard:</strong> Mark doesn't hide the fact that following Jesus can be difficult. Even Jesus's closest disciples often didn't understand what He was teaching them.</p>
        <p><strong>Jesus Came to Serve:</strong> One of the most important verses in Mark's Gospel is when Jesus says, "The Son of Man did not come to be served, but to serve, and to give his life as a ransom for many."</p>
        <p><strong>Faith vs. Fear:</strong> Throughout Mark's Gospel, Jesus often asks His disciples, "Why are you afraid? Where is your faith?"</p>
    </div>

    <fieldset class="highlight-box">
        <legend><h2><span class="emoji">🏃</span>Mark's Distinctive Approach to Sermons and Discourses</h2></legend>
...
ministry and message.</p>
    ...
    <fieldset class="story-box">
        <legend><h2><span class="emoji">🏃</span>Mark's Action-Oriented Narrative</h2></legend>
...
philosophical sophistication.</p>
    ...
    <fieldset class="story-box">
        <legend><h2><span class="emoji">🏃</span>Mark's Presentation of Jesus's Teachings</h2></legend>
...
servant ministry.</p>
    ...
    <fieldset class="highlight-box">
        <legend><h2><span class="emoji">🏃</span>Mark's Unique Narrative Techniques</h2></legend>
...
Jesus's identity and mission.</p>
    ...
    <fieldset class="story-box">
        <legend><h2><span class="emoji">🏃</span>Mark's Distinctive Emphases</h2></legend>
...
participation in God's current work rather than merely preparation for a future reality.</p>
    ...
    <fieldset class="story-box">
        <legend><h2><span class="emoji">🏃</span>Mark's Theological Contribution</h2></legend>
...
demands of authentic discipleship.</p>
    ...
    ?>
            ...
            <section id="^" class="section fullbar">
                ...
                <p>[1] Circe Institute. "The 5 Discourses of Jesus." Circe Institute Blog. Accessed June 7,
                    2025. <a
                        href="https://circeinstitute.org/blog/blog-5-discourses-jesus/">https://circeinstitute.org/blog/blog-5-discourses-jesus/</a>
                    [2] Wikipedia. "Five Discourses of Matthew." Wikipedia, The Free Encyclopedia. Accessed
                    June 7, 2025. <a
                        href="https://en.wikipedia.org/wiki/Five_Discourses_of_Matthew">https://en.wikipedia.org/wiki/Five_Discourses_of_Matthew</a>
                    [3] Circe Institute. "The 5 Discourses of Jesus." Circe Institute Blog. Accessed June 7,
                    2025. <a
                        href="https://circeinstitute.org/blog/blog-5-discourses-jesus/">https://circeinstitute.org/blog/blog-5-discourses-jesus/</a>
                    [4] Campbell United Methodist Church. "Jesus in the Gospel of John: The Discourses of
                    Jesus." Campbell United. March 18, 2018. <a href="https://www.campbellunited.org/documents/
sermons/20180318_Jesus-In-Gospel-of-John_The-Discourses-of-Jesus.pdf">https://www.campbellunited.org/documents/
                        sermons/20180318_Jesus-In-Gospel-of-John_The-Discourses-of-Jesus.pdf</a>
                    [5] Christianity Applied. "The Discourses of Christ in Chronological Order." Christianity
                    Applied. January 2025. <a href="https://www.christianityapplied.org/wp-content/uploads/
2025/01/The-Discourses-of-Christ-in-Chronological-Order.pdf">https://www.christianityapplied.org/wp-content/uploads/
                        2025/01/The-Discourses-of-Christ-in-Chronological-Order.pdf</a>
                    [6] BibleHub. "John: Jesus' Discourses Upon." Nave's Topical Bible. Accessed June 7,
                    2025. <a
                        href="https://biblehub.com/topical/naves/j/john--jesus_discourses_upon.htm">https://biblehub.com/topical/naves/j/john--jesus_discourses_upon.htm</a>
                    [7] Reinstorf, D. H. "Mark's Unique Contribution." Religious Studies Center, Brigham
                    Young University. Vol. 17, No. 2, 2016. <a href="https://rsc.byu.edu/vol-17-no-2-2016/marks-
unique-contribution">https://rsc.byu.edu/vol-17-no-2-2016/marks-
                        unique-contribution</a>
                    [8] Public Square Magazine. "Unearthing the Overlooked Gems of Luke's Sermon on the
                    Plain." Public Square Magazine. Accessed June 7, 2025. <a href="https://publicsquaremag.org/
faith/gospel-fare/unearthing-the-overlooked-gems-of-lukes-sermon-on-the-plain/">https://publicsquaremag.org/
                        faith/gospel-fare/unearthing-the-overlooked-gems-of-lukes-sermon-on-the-plain/</a>
                    [9] Quora. "Is it accurate that the gospel of Luke contains 17 unique parables of Jesus?"
                    Quora. Accessed June 7, 2025. <a href="https://www.quora.com/Is-it-accurate-that-the-gospel-of-
Luke-contains-17-unique-parables-of-Jesus">https://www.quora.com/Is-it-accurate-that-the-gospel-of-
                        Luke-contains-17-unique-parables-of-Jesus</a>
                <p>This comprehensive guide represents a synthesis of scholarly research and biblical
                    analysis aimed at providing readers with a clear understanding of how Jesus's sermons
                    and discourses are distributed across the four Gospels. The categorization presented
                    here is based on careful examination of the Gospel texts and consultation of multiple
                    scholarly sources to ensure accuracy and comprehensiveness.</p>
            </section>
            <?php
    else:
    ?>
            <section class="section fullbar">
                ...
                <h2><span class="emoji">📚</span>What This Guide Is About</h2>
                <p>Hi there! This guide is all about the amazing things Jesus taught when He lived on Earth about 2,000
                    years ago. Jesus was God's son, and He came to teach people how to live good lives and how to love
                    God
                    and each other.</p>

                <p>The stories about Jesus are written in four special books called the Gospels. These books are named
                    Matthew, Mark, Luke, and John - after the people who wrote them. Each writer told the story of Jesus
                    in
                    their own way, kind of like how you and your friends might tell the same story but focus on
                    different
                    parts.</p>
